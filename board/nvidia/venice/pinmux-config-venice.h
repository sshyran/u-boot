...
#ifndef _PINMUX_CONFIG_VENICE_H_
#define _PINMUX_CONFIG_VENICE_H_
...
static struct pingroup_config tegra114_pinmux_common[] = {
	...
	/* EC KBC/SPI */
	DEFAULT_PINMUX(ULPI_DATA4,    SPI2,        UP,        NORMAL,   INPUT),
	DEFAULT_PINMUX(ULPI_DATA5,    SPI2,        UP,        NORMAL,   INPUT),
	...
	/* UARTD pinmux (UART4 on Servo board?) */
	...
	DEFAULT_PINMUX(CLK2_OUT,      RSVD1,       NORMAL,    NORMAL,   OUTPUT),
	...
	/* unused, SNN_ on schematic, TRISTATE 'em */
	DEFAULT_PINMUX(UART2_CTS_N,   RSVD2,       NORMAL,    TRISTATE, OUTPUT),
	DEFAULT_PINMUX(UART2_RTS_N,   RSVD2,       NORMAL,    TRISTATE, INPUT),
	DEFAULT_PINMUX(UART2_RXD,     RSVD1,       NORMAL,    TRISTATE, OUTPUT),
	DEFAULT_PINMUX(UART2_TXD,     RSVD1,       NORMAL,    TRISTATE, OUTPUT),
...
static struct pingroup_config tegra114_pinmux_set_nontristate[] = {
	...
	/* Needed by display - EDP_EN (GMI_AD3, above), LCD_STDBY, LCD_RST */
	...
	DEFAULT_PINMUX(SDMMC1_WP_N,     SDMMC1, UP,      NORMAL,    OUTPUT),
...
static struct padctrl_config venice_padctrl[] = {
