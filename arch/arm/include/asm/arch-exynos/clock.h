...
struct exynos5420_clock {
	...
	unsigned int apll_con1;
	unsigned char res2[0xf8];
	unsigned int clk_src_cpu;
	unsigned char res3[0x1fc];
	unsigned int clk_mux_stat_cpu;
	unsigned char res4[0xfc];
	unsigned int clk_div_cpu0;		/* 0x10010500 */
	unsigned int clk_div_cpu1;
	unsigned char res5[0xf8];
	unsigned int clk_div_stat_cpu0;
	unsigned int clk_div_stat_cpu1;
	unsigned char res6[0xf8];
	unsigned int clk_gate_bus_cpu;
	unsigned char res7[0xfc];
	unsigned int clk_gate_sclk_cpu;
	...
	unsigned int clk_src_cperi0;		/* 0x10014200 */
	unsigned int clk_src_cperi1;
	unsigned char res21[0xf8];
	unsigned int clk_src_mask_cperi;
	unsigned char res22[0x100];
	unsigned int clk_mux_stat_cperi1;
	unsigned char res23[0xfc];
	unsigned int clk_div_cperi1;
	unsigned char res24[0xfc];
	unsigned int clk_div_stat_cperi1;
	unsigned char res25[0xf8];
	unsigned int clk_gate_bus_cperi0;	/* 0x10014700 */
	unsigned int clk_gate_bus_cperi1;
	unsigned char res26[0xf8];
	unsigned int clk_gate_sclk_cperi;
	unsigned char res27[0xfc];
	unsigned int clk_gate_ip_cperi;
	...
	unsigned int clk_div_g2d;
	unsigned char res37[0xfc];
	unsigned int clk_div_stat_g2d;
	unsigned char res38[0xfc];
	unsigned int clk_gate_bus_g2d;
	unsigned char res39[0xfc];
	unsigned int clk_gate_ip_g2d;
	...
	unsigned int clk_div_cmu_isp0;
	unsigned int clk_div_cmu_isp1;
	unsigned int clk_div_isp2;		/* 0x1001c308 */
	unsigned char res44[0xf4];
	unsigned int clk_div_stat_cmu_isp0;
	unsigned int clk_div_stat_cmu_isp1;
	unsigned int clk_div_stat_isp2;
	unsigned char res45[0x2f4];
	unsigned int clk_gate_bus_isp0;
	unsigned int clk_gate_bus_isp1;
	unsigned int clk_gate_bus_isp2;
	unsigned int clk_gate_bus_isp3;
	unsigned char res46[0xf0];
	unsigned int clk_gate_ip_isp0;
	unsigned int clk_gate_ip_isp1;
	unsigned char res47[0xf8];
	unsigned int clk_gate_sclk_isp;
	...
	unsigned int clk_src_top0;		/* 0x10020200 */
	unsigned int clk_src_top1;
	unsigned int clk_src_top2;
	unsigned int clk_src_top3;
	unsigned int clk_src_top4;
	...
	unsigned int clk_src_fsys;
	unsigned char res67[0x8];
	unsigned int clk_src_peric0;
	unsigned int clk_src_peric1;
	unsigned char res68[0x18];
	unsigned int clk_src_isp;
	unsigned char res69[0x0c];
	unsigned int clk_src_top10;
	unsigned int clk_src_top11;
	unsigned int clk_src_top12;
	unsigned char res70[0x74];
	unsigned int clk_src_mask_top0;
	unsigned int clk_src_mask_top1;
	unsigned int clk_src_mask_top2;
	unsigned char res71[0x10];
	unsigned int clk_src_mask_top7;
	unsigned char res72[0xc];
	unsigned int clk_src_mask_disp10;	/* 0x1002032c */
	unsigned char res73[0x4];
	unsigned int clk_src_mask_mau;
	unsigned char res74[0x8];
	unsigned int clk_src_mask_fsys;
	unsigned char res75[0xc];
	unsigned int clk_src_mask_peric0;
	unsigned int clk_src_mask_peric1;
	unsigned char res76[0x18];
	unsigned int clk_src_mask_isp;
	unsigned char res77[0x8c];
	unsigned int clk_mux_stat_top0;		/* 0x10020400 */
	unsigned int clk_mux_stat_top1;
	unsigned int clk_mux_stat_top2;
	unsigned int clk_mux_stat_top3;
	unsigned int clk_mux_stat_top4;
	unsigned int clk_mux_stat_top5;
	unsigned int clk_mux_stat_top6;
	unsigned int clk_mux_stat_top7;
	unsigned char res78[0x60];
	unsigned int clk_mux_stat_top10;
	unsigned int clk_mux_stat_top11;
	unsigned int clk_mux_stat_top12;
	unsigned char res79[0x74];
	unsigned int clk_div_top0;		/* 0x10020500 */
	unsigned int clk_div_top1;
	unsigned int clk_div_top2;
	unsigned char res80[0x20];
	unsigned int clk_div_disp10;
	unsigned char res81[0x14];
	unsigned int clk_div_mau;
	unsigned int clk_div_fsys0;
	unsigned int clk_div_fsys1;
	unsigned int clk_div_fsys2;
	unsigned char res82[0x4];
	unsigned int clk_div_peric0;
	unsigned int clk_div_peric1;
	unsigned int clk_div_peric2;
	unsigned int clk_div_peric3;
	unsigned int clk_div_peric4;		/* 0x10020568 */
	...
	unsigned int clk_div_stat_disp10;
	unsigned char res87[0x14];
	unsigned int clk_div_stat_mau;		/* 0x10020644 */
	unsigned int clk_div_stat_fsys0;
	unsigned int clk_div_stat_fsys1;
	unsigned int clk_div_stat_fsys2;
	unsigned char res88[0x4];
	unsigned int clk_div_stat_peric0;
	unsigned int clk_div_stat_peric1;
	unsigned int clk_div_stat_peric2;
	unsigned int clk_div_stat_peric3;
	unsigned int clk_div_stat_peric4;
	...
	unsigned int clk_gate_bus_top;		/* 0x10020700 */
	unsigned char res93[0xc];
	unsigned int clk_gate_bus_gscl0;
	unsigned char res94[0xc];
	unsigned int clk_gate_bus_gscl1;
	unsigned char res95[0x4];
	unsigned int clk_gate_bus_disp1;
	unsigned char res96[0x4];
	unsigned int clk_gate_bus_wcore;
	unsigned int clk_gate_bus_mfc;
	unsigned int clk_gate_bus_g3d;
	unsigned int clk_gate_bus_gen;
	unsigned int clk_gate_bus_fsys0;
	unsigned int clk_gate_bus_fsys1;
	unsigned int clk_gate_bus_fsys2;
	unsigned int clk_gate_bus_mscl;
	unsigned int clk_gate_bus_peric;
	unsigned int clk_gate_bus_peric1;
	unsigned char res97[0x8];
	unsigned int clk_gate_bus_peris0;
	unsigned int clk_gate_bus_peris1;	/* 0x10020764 */
	unsigned char res98[0x8];
	unsigned int clk_gate_bus_noc;
	unsigned char res99[0xac];
	unsigned int clk_gate_top_sclk_gscl;
	unsigned char res1000[0x4];
	unsigned int clk_gate_top_sclk_disp1;
	unsigned char res100[0x10];
	unsigned int clk_gate_top_sclk_mau;
	unsigned int clk_gate_top_sclk_fsys;
	unsigned char res101[0xc];
	unsigned int clk_gate_top_sclk_peric;
	unsigned char res102[0xc];
	unsigned int clk_gate_top_sclk_cperi;
	unsigned char res103[0xc];
	unsigned int clk_gate_top_sclk_isp;
	unsigned char res104[0x9c];
	unsigned int clk_gate_ip_gscl0;
	unsigned char res105[0xc];
	unsigned int clk_gate_ip_gscl1;
	unsigned char res106[0x4];
	unsigned int clk_gate_ip_disp1;
	unsigned int clk_gate_ip_mfc;
	unsigned int clk_gate_ip_g3d;
	unsigned int clk_gate_ip_gen;		/* 0x10020934 */
	unsigned char res107[0xc];
	unsigned int clk_gate_ip_fsys;
	unsigned char res108[0x8];
	unsigned int clk_gate_ip_peric;
	unsigned char res109[0xc];
	unsigned int clk_gate_ip_peris;
	unsigned char res110[0xc];
	unsigned int clk_gate_ip_mscl;
	unsigned char res111[0xc];
	unsigned int clk_gate_ip_block;
	...
	unsigned int clk_src_cdrex;
	unsigned char res119[0x1fc];
	unsigned int clk_mux_stat_cdrex;
	unsigned char res120[0xfc];
	unsigned int clk_div_cdrex0;
	unsigned int clk_div_cdrex1;
	unsigned char res121[0xf8];
	unsigned int clk_div_stat_cdrex;
	unsigned char res1211[0xfc];
	unsigned int clk_gate_bus_cdrex;
	unsigned int clk_gate_bus_cdrex1;
	unsigned char res122[0x1f8];
	unsigned int clk_gate_ip_cdrex;
	...
	unsigned int clk_src_kfc;
	unsigned char res132[0x1fc];
	unsigned int clk_mux_stat_kfc;		/* 0x10038400 */
	...
	unsigned int clk_gate_bus_cpu_kfc;
	unsigned char res136[0xfc];
	unsigned int clk_gate_sclk_cpu_kfc;
...
#define EXYNOS5420_CLK_SRC_SCLK_EPLL	0x6
