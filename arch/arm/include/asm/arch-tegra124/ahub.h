/*
 * Adapted from T114 ahub.h, which came from the Linux Tegra30 AHUB driver
 *
...
#ifndef __TEGRA124_AHUB_H__
#define __TEGRA124_AHUB_H__

/* Fields in *_CIF_RX/TX_CTRL used by AHUB FIFOs and all other audio modules */

#define TEGRA_AUDIOCIF_CTRL_FIFO_THRESHOLD_SHIFT	24
#define TEGRA_AUDIOCIF_CTRL_FIFO_THRESHOLD_MASK_US	0x3f
#define TEGRA_AUDIOCIF_CTRL_FIFO_THRESHOLD_MASK		(TEGRA_AUDIOCIF_CTRL_FIFO_THRESHOLD_MASK_US << TEGRA_AUDIOCIF_CTRL_FIFO_THRESHOLD_SHIFT)

/* Channel count minus 1 */
#define TEGRA_AUDIOCIF_CTRL_AUDIO_CHANNELS_SHIFT	20
#define TEGRA_AUDIOCIF_CTRL_AUDIO_CHANNELS_MASK_US	0xf
#define TEGRA_AUDIOCIF_CTRL_AUDIO_CHANNELS_MASK		(TEGRA_AUDIOCIF_CTRL_AUDIO_CHANNELS_MASK_US << TEGRA_AUDIOCIF_CTRL_AUDIO_CHANNELS_SHIFT)

/* Channel count minus 1 */
#define TEGRA_AUDIOCIF_CTRL_CLIENT_CHANNELS_SHIFT	16
#define TEGRA_AUDIOCIF_CTRL_CLIENT_CHANNELS_MASK_US	0xf
#define TEGRA_AUDIOCIF_CTRL_CLIENT_CHANNELS_MASK	(TEGRA_AUDIOCIF_CTRL_CLIENT_CHANNELS_MASK_US << TEGRA_AUDIOCIF_CTRL_CLIENT_CHANNELS_SHIFT)

#define TEGRA_AUDIOCIF_BITS_4			0
#define TEGRA_AUDIOCIF_BITS_8			1
#define TEGRA_AUDIOCIF_BITS_12			2
#define TEGRA_AUDIOCIF_BITS_16			3
#define TEGRA_AUDIOCIF_BITS_20			4
#define TEGRA_AUDIOCIF_BITS_24			5
#define TEGRA_AUDIOCIF_BITS_28			6
#define TEGRA_AUDIOCIF_BITS_32			7

#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT	12
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_MASK	(7 << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_4	(TEGRA_AUDIOCIF_BITS_4  << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_8	(TEGRA_AUDIOCIF_BITS_8  << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_12	(TEGRA_AUDIOCIF_BITS_12 << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_16	(TEGRA_AUDIOCIF_BITS_16 << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_20	(TEGRA_AUDIOCIF_BITS_20 << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_24	(TEGRA_AUDIOCIF_BITS_24 << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_28	(TEGRA_AUDIOCIF_BITS_28 << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_32	(TEGRA_AUDIOCIF_BITS_32 << TEGRA_AUDIOCIF_CTRL_AUDIO_BITS_SHIFT)

#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT	8
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_MASK	(7 << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_4	(TEGRA_AUDIOCIF_BITS_4  << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_8	(TEGRA_AUDIOCIF_BITS_8  << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_12	(TEGRA_AUDIOCIF_BITS_12 << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_16	(TEGRA_AUDIOCIF_BITS_16 << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_20	(TEGRA_AUDIOCIF_BITS_20 << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_24	(TEGRA_AUDIOCIF_BITS_24 << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_28	(TEGRA_AUDIOCIF_BITS_28 << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_32	(TEGRA_AUDIOCIF_BITS_32 << TEGRA_AUDIOCIF_CTRL_CLIENT_BITS_SHIFT)

#define TEGRA_AUDIOCIF_EXPAND_ZERO		0
#define TEGRA_AUDIOCIF_EXPAND_ONE		1
#define TEGRA_AUDIOCIF_EXPAND_LFSR		2

#define TEGRA_AUDIOCIF_CTRL_EXPAND_SHIFT	6
#define TEGRA_AUDIOCIF_CTRL_EXPAND_MASK		(3 << TEGRA_AUDIOCIF_CTRL_EXPAND_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_EXPAND_ZERO		(TEGRA_AUDIOCIF_EXPAND_ZERO << TEGRA_AUDIOCIF_CTRL_EXPAND_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_EXPAND_ONE		(TEGRA_AUDIOCIF_EXPAND_ONE  << TEGRA_AUDIOCIF_CTRL_EXPAND_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_EXPAND_LFSR		(TEGRA_AUDIOCIF_EXPAND_LFSR << TEGRA_AUDIOCIF_CTRL_EXPAND_SHIFT)

#define TEGRA_AUDIOCIF_STEREO_CONV_CH0		0
#define TEGRA_AUDIOCIF_STEREO_CONV_CH1		1
#define TEGRA_AUDIOCIF_STEREO_CONV_AVG		2

#define TEGRA_AUDIOCIF_CTRL_STEREO_CONV_SHIFT	4
#define TEGRA_AUDIOCIF_CTRL_STEREO_CONV_MASK	(3 << TEGRA_AUDIOCIF_CTRL_STEREO_CONV_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_STEREO_CONV_CH0	(TEGRA_AUDIOCIF_STEREO_CONV_CH0 << TEGRA_AUDIOCIF_CTRL_STEREO_CONV_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_STEREO_CONV_CH1	(TEGRA_AUDIOCIF_STEREO_CONV_CH1 << TEGRA_AUDIOCIF_CTRL_STEREO_CONV_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_STEREO_CONV_AVG	(TEGRA_AUDIOCIF_STEREO_CONV_AVG << TEGRA_AUDIOCIF_CTRL_STEREO_CONV_SHIFT)

#define TEGRA_AUDIOCIF_CTRL_REPLICATE		3

#define TEGRA_AUDIOCIF_DIRECTION_TX		0
#define TEGRA_AUDIOCIF_DIRECTION_RX		1

#define TEGRA_AUDIOCIF_CTRL_DIRECTION_SHIFT	2
#define TEGRA_AUDIOCIF_CTRL_DIRECTION_MASK	(1 << TEGRA_AUDIOCIF_CTRL_DIRECTION_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_DIRECTION_TX	(TEGRA_AUDIOCIF_DIRECTION_TX << TEGRA_AUDIOCIF_CTRL_DIRECTION_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_DIRECTION_RX	(TEGRA_AUDIOCIF_DIRECTION_RX << TEGRA_AUDIOCIF_CTRL_DIRECTION_SHIFT)

#define TEGRA_AUDIOCIF_TRUNCATE_ROUND		0
#define TEGRA_AUDIOCIF_TRUNCATE_CHOP		1

#define TEGRA_AUDIOCIF_CTRL_TRUNCATE_SHIFT	1
#define TEGRA_AUDIOCIF_CTRL_TRUNCATE_MASK	(1 << TEGRA_AUDIOCIF_CTRL_TRUNCATE_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_TRUNCATE_ROUND	(TEGRA_AUDIOCIF_TRUNCATE_ROUND << TEGRA_AUDIOCIF_CTRL_TRUNCATE_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_TRUNCATE_CHOP	(TEGRA_AUDIOCIF_TRUNCATE_CHOP  << TEGRA_AUDIOCIF_CTRL_TRUNCATE_SHIFT)

#define TEGRA_AUDIOCIF_MONO_CONV_ZERO		0
#define TEGRA_AUDIOCIF_MONO_CONV_COPY		1

#define TEGRA_AUDIOCIF_CTRL_MONO_CONV_SHIFT	0
#define TEGRA_AUDIOCIF_CTRL_MONO_CONV_MASK	(1 << TEGRA_AUDIOCIF_CTRL_MONO_CONV_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_MONO_CONV_ZERO	(TEGRA_AUDIOCIF_MONO_CONV_ZERO << TEGRA_AUDIOCIF_CTRL_MONO_CONV_SHIFT)
#define TEGRA_AUDIOCIF_CTRL_MONO_CONV_COPY	(TEGRA_AUDIOCIF_MONO_CONV_COPY << TEGRA_AUDIOCIF_CTRL_MONO_CONV_SHIFT)
...
#define TEGRA_PACK_8_4					2
#define TEGRA_PACK_16					3
...
#define TEGRA_AHUB_CHANNEL_CTRL_TX_PACK_8_4		(TEGRA_PACK_8_4 << TEGRA_AHUB_CHANNEL_CTRL_TX_PACK_SHIFT)
#define TEGRA_AHUB_CHANNEL_CTRL_TX_PACK_16		(TEGRA_PACK_16 << TEGRA_AHUB_CHANNEL_CTRL_TX_PACK_SHIFT)
...
#define TEGRA_AHUB_CHANNEL_CTRL_RX_PACK_8_4		(TEGRA_PACK_8_4 << TEGRA_AHUB_CHANNEL_CTRL_RX_PACK_SHIFT)
#define TEGRA_AHUB_CHANNEL_CTRL_RX_PACK_16		(TEGRA_PACK_16 << TEGRA_AHUB_CHANNEL_CTRL_RX_PACK_SHIFT)
...
/* Registers within TEGRA_AHUB_BASE */

#define TEGRA_AHUB_AUDIO_RX				0x0
#define TEGRA_AHUB_AUDIO_RX_STRIDE			0x4
#define TEGRA_AHUB_AUDIO_RX_COUNT			17

/* This register repeats once for each entry in enum tegra_ahub_rxcif */
/* The fields in this register are 1 bit per entry in tegra_ahub_txcif */
...
struct audio_ctlr {
	uint audio_apbif_rx0;		/* AUDIO_APBIF_RX0, offset 0x00 */
	uint audio_apbif_rx1;		/* AUDIO_APBIF_RX1, offset 0x04 */
	uint audio_apbif_rx2;		/* AUDIO_APBIF_RX2, offset 0x08 */
	uint audio_apbif_rx3;		/* AUDIO_APBIF_RX3, offset 0x0C */

	uint audio_i2s0_rx0;		/* AUDIO_I2S0_RX0,  offset 0x10 */
	uint audio_i2s1_rx0;		/* AUDIO_I2S1_RX0,  offset 0x14 */
	uint audio_i2s2_rx0;		/* AUDIO_I2S2_RX0,  offset 0x18 */
	uint audio_i2s3_rx0;		/* AUDIO_I2S3_RX0,  offset 0x1C */
	uint audio_i2s4_rx0;		/* AUDIO_I2S4_RX0,  offset 0x20 */

	uint audio_dam0_rx0;		/* AUDIO_DAM0_RX0,  offset 0x24 */
	uint audio_dam0_rx1;		/* AUDIO_DAM0_RX1,  offset 0x28 */
	uint audio_dam1_rx0;		/* AUDIO_DAM1_RX0,  offset 0x2C */
	uint audio_dam1_rx1;		/* AUDIO_DAM1_RX1,  offset 0x30 */
	uint audio_dam2_rx0;		/* AUDIO_DAM2_RX0,  offset 0x34 */
	uint audio_dam2_rx1;		/* AUDIO_DAM2_RX1,  offset 0x38 */

	uint audio_spdif_rx0;		/* AUDIO_SPDIF_RX0, offset 0x3C */
	uint audio_spdif_rx1;		/* AUDIO_SPDIF_RX1, offset 0x40 */

	uint audio_apbif_rx4;		/* AUDIO_APBIF_RX4, offset 0x44 */
	uint audio_apbif_rx5;		/* AUDIO_APBIF_RX4, offset 0x48 */
	uint audio_apbif_rx6;		/* AUDIO_APBIF_RX4, offset 0x4C */
	uint audio_apbif_rx7;		/* AUDIO_APBIF_RX4, offset 0x50 */
	uint audio_apbif_rx8;		/* AUDIO_APBIF_RX4, offset 0x54 */
	uint audio_apbif_rx9;		/* AUDIO_APBIF_RX4, offset 0x58 */

	uint audio_amx0_rx0;		/* AUDIO_AMX0_RX0,  offset 0x5C */
	uint audio_amx0_rx1;		/* AUDIO_AMX0_RX1,  offset 0x60 */
	uint audio_amx0_rx2;		/* AUDIO_AMX0_RX2,  offset 0x64 */
	uint audio_amx0_rx3;		/* AUDIO_AMX0_RX3,  offset 0x68 */

	uint audio_adx0_rx0;		/* AUDIO_ADX0_RX0,  offset 0x6C */
};

struct ahub_ctlr {
	uint ahub_channel0_ctrl;	/* APBIF_CHANNEL0_CTRL */
	uint ahub_channel0_clr;		/* APBIF_CHANNEL0_CLEAR */
	uint ahub_channel0_stat;	/* APBIF_CHANNEL0_STATUS */
	uint ahub_channel0_txfifo;	/* APBIF_CHANNEL0_TXFIFO */
	uint ahub_channel0_rxfifo;	/* APBIF_CHANNEL0_RXFIFO */
	uint ahub_channel0_cif_tx0_ctrl;	/* APBIF_AUDIOCIF_TX0_CTRL */
	uint ahub_channel0_cif_rx0_ctrl;	/* APBIF_AUDIOCIF_RX0_CTRL */
	uint ahub_channel0_reserved0;		/* RESERVED, offset 0x1C */
	...
	uint reserved123[3*8*4];
	uint ahub_config_link_ctrl;	/* APBIF_CONFIG_LINK_CTRL_0, off 0x80 */
	uint ahub_misc_ctrl;		/* APBIF_MISC_CTRL_0, offset 0x84 */
	uint ahub_apbdma_live_stat;	/* APBIF_APBDMA_LIVE_STATUS_0 */
	uint ahub_i2s_live_stat;	/* APBIF_I2S_LIVE_STATUS_0 */
	uint ahub_dam0_live_stat;	/* APBIF_DAM0_LIVE_STATUS_0 */
	uint ahub_dam1_live_stat;	/* APBIF_DAM0_LIVE_STATUS_0 */
	uint ahub_dam2_live_stat;	/* APBIF_DAM0_LIVE_STATUS_0 */
	uint ahub_spdif_live_stat;	/* APBIF_SPDIF_LIVE_STATUS_0 */
	uint ahub_i2s_int_mask;		/* APBIF_I2S_INT_MASK_0, offset 0xB0 */
	uint ahub_dam_int_mask;		/* APBIF_DAM_INT_MASK_0 */
	uint ahub_reserved_int_mask;	/* RESERVED, offset 0xB8 */
	uint ahub_spdif_int_mask;	/* APBIF_SPDIF_INT_MASK_0 */
	uint ahub_apbif_int_mask;	/* APBIF_APBIF_INT_MASK_0, off 0xC0 */
	uint ahub_reserved2_int_mask;	/* RESERVED, offset 0xC4 */
	uint ahub_i2s_int_stat;		/* APBIF_I2S_INT_STATUS_0, offset 0xC8 */
	uint ahub_dam_int_stat;		/* APBIF_DAM_INT_STATUS_0 */
	uint ahub_reserved_int_stat;	/* RESERVED, offset 0xD0 */
	uint ahub_spdif_int_stat;	/* APBIF_SPDIF_INT_STATUS_0 */
	uint ahub_apbif_int_stat;	/* APBIF_APBIF_INT_STATUS_0 */
	uint ahub_reserved2_int_stat;	/* RESERVED, offset 0xDC */
	uint ahub_i2s_int_src;		/* APBIF_I2S_INT_SOURCE_0, offset 0xE0 */
	uint ahub_dam_int_src;		/* APBIF_DAM_INT_SOURCE_0 */
	uint ahub_reserved_int_src;	/* RESERVED, offset 0xE8 */
	uint ahub_spdif_int_src;	/* APBIF_SPDIF_INT_SOURCE_0 */
	uint ahub_apbif_int_src;	/* APBIF_APBIF_INT_SOURCE_0, off 0xF0 */
	uint ahub_reserved2_int_src;	/* RESERVED, offset 0xF4 */
	uint ahub_i2s_int_set;		/* APBIF_I2S_INT_SET_0, offset 0xF8 */
	uint ahub_dam_int_set;		/* APBIF_DAM_INT_SET_0, offset 0xFC */
	uint ahub_spdif_int_set;	/* APBIF_SPDIF_INT_SET_0, off 0x100 */
	uint ahub_apbif_int_set;	/* APBIF_APBIF_INT_SET_0, off 0x104 */
};

#endif	/* __TEGRA124_AHUB_H__ */
